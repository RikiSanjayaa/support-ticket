...
function initAttachmentHandler(inputSelector, previewSelector, dropZoneSelector = null) {
    ...
    if (dropZoneSelector) {
        ...
        // Only prevent defaults for dragenter, dragover, dragleave
        ...
        // Don't handle drop manually, let browser handle it
        dropZone.addEventListener('drop', () => {
            unhighlight(dropZone);
            // Browser sets input.files automatically if drop happens over <input>
            // So force preview refresh
